...
# Handles data validation and serialization for user registration, login, and OTP verification.
# """

# from rest_framework import serializers
# from django.contrib.auth import authenticate
# from django.contrib.auth.password_validation import validate_password
# from .models import User, EmailOTP, VerificationDocument
# from django.db import models


# class UserRegistrationSerializer(serializers.ModelSerializer):
#     """
#     Serializer for user registration with document verification support.
#     """
...
#     # Document fields (optional, required only for designers/tailors)
...
#         """Validate password confirmation and documents for designers/tailors"""
#         # Password validation
...
#         # Document validation for designers and tailors
#         role = attrs.get("role", User.Role.CUSTOMER)
#         if role in [User.Role.DESIGNER, User.Role.TAILOR]:
#             if not attrs.get("business_name"):
#                 raise serializers.ValidationError(
#                     {
#                         "business_name": "Business/Professional name is required for designers and tailors."
#                     }
#                 )
#             if not attrs.get("experience"):
#                 raise serializers.ValidationError(
#                     {"experience": "Experience is required for designers and tailors."}
#                 )
#             if not attrs.get("specialization"):
#                 raise serializers.ValidationError(
#                     {
#                         "specialization": "Specialization is required for designers and tailors."
#                     }
#                 )
...
#         # Remove password_confirm and document fields
...
#                     EmailOTP.Purpose.LOGIN_2FA,  # ← add this
#                 ],
#                 is_verified=False,
#             )
#             .order_by("-created_at")
...
#         # Store OTP object for use in view
...
#         choices=EmailOTP.Purpose.choices, default=EmailOTP.Purpose.EMAIL_VERIFICATION
#     )
...
#     """
#     Serializer for user login with verification check.
#     """
...
#         # Check verification status for designers/tailors
#         if user.requires_verification():
...
#                 raise serializers.ValidationError(
#                     {
#                         "email": f"Your account verification was rejected. Reason: {user.verification_notes or 'Please contact support.'}"
#                     }
#                 )
...
#     Validates Google ID token and creates/returns user.
#     """
